...
import com.villascode.allme.appuser.AppUserRole;
import com.villascode.allme.appuser.AppUserService;
import com.villascode.allme.email.EmailSender;
...
public class RegistrationService {
    ...
    private final String EMAIL_ERROR_MSG="The email : %s is not valid";
    ...
    public String register(RegistrationRequest request){
        ...
        if (!isValidEmail){
            throw new IllegalStateException(String.format(EMAIL_ERROR_MSG,request.getEmail()));
        }
    ...
    public String confirmToken(String token){
        ...
        if(confirmationToken.getConfirmedOn() !=null){
            throw new IllegalStateException("Email already confirmed");
        }

        LocalDateTime expiresOn = confirmationToken.getExpiresOn();
